...
st.markdown("""
<style>
/* بهتر کردن خوانایی متن‌های فارسی */
@import url('https://fonts.googleapis.com/css2?family=Vazirmatn:wght@300;400;500;600;700;800&display=swap');

html, body, [class*="css"] {
    font-family: 'Vazirmatn', Tahoma, Arial, 'Noto Naskh Arabic', sans-serif;
    direction: rtl;
    text-align: right;
    font-size: 16px;
    line-height: 1.7;
...
/* عمومی برای متن‌های استریم‌لیت */
.stMarkdown, .stText, .stMarkdown > div, .stText > div, .css-1d391kg { /* generic container */
    font-size: 16px;
    line-height: 1.7;
}
...
/* کمک برای شکست درست کلمات فارسی */
p, li {
    word-break: normal;
...
#     """
#     try:
#         resp = requests.get(f'{API_BASE_URL}/health', timeout=50)
