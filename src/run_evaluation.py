...
if __name__ == '__main__':
    ...
    summary = run_evaluation(questions_path=f'{project_root}/src/evaluation/eval_questions.json', verbose=True)
    with open(f'{project_root}/src/evaluation/eval_results.json', 'w', encoding='utf-8') as f:
